...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\raul.de.almeida.neto\Projetos\zerosum'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\raul.de.almeida.neto\Projetos\zerosum\Scripts\deactivate.nu'
